    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.subtitle}>
          SOL is the native cryptocurrency of the Solana blockchain. You need a small amount to cover transaction fees when posting on Beam.
        </Text>
        ...
        <View style={styles.reasonsContainer}>
          ...
          <View style={styles.reasonItem}>
            ...
            <Text style={styles.reasonText}>
              <Text style={{fontWeight: '600'}}>Transaction Fees:</Text> Every post on Beam is stored on the Solana blockchain, which requires a small fee (usually ~$0.01).
            </Text>
          </View>
          ...
          <View style={styles.reasonItem}>
            <Zap size={20} color={colors.primary} style={styles.reasonIcon} />
            <Text style={styles.reasonText}>
              <Text style={{fontWeight: '600'}}>Decentralization:</Text> These fees help secure the Solana network and ensure your posts are permanently stored.
            </Text>
          </View>
          ...
          <View style={styles.reasonItem}>
            <Zap size={20} color={colors.primary} style={styles.reasonIcon} />
            <Text style={styles.reasonText}>
              <Text style={{fontWeight: '600'}}>Ownership:</Text> Your posts are truly yours and can't be censored or deleted by any centralized authority.
            </Text>
          </View>
        </View>
        ...
        <View style={styles.exchangesContainer}>
          ...
          <Pressable 
            ...
            onPress={() => handleOpenExchange('https://www.coinbase.com/price/solana')}>
          ...
          <Pressable 
            style={styles.exchangeButton}
            onPress={() => handleOpenExchange('https://www.kraken.com/prices/solana')}>
            <View style={styles.exchangeInfo}>
        ...
        <View style={styles.noteContainer}>
          <Text style={styles.noteText}>
            After purchasing SOL, send it to your connected Solana wallet. You only need a small amount (0.001 SOL or more) to get started with posting.
          </Text>
        </View>
